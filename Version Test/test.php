...
if (isset($_GET['nuke'])) {
    if ($_GET['nuke'] === 'confirm') {
        ...
        // Affichage vidéo plein écran, rien d'autre
        echo '
        <style>
        html, body {
            margin: 0;
        ...
        <video class="nuke_video" autoplay >
            <source src="nukes.mp4" type="video/mp4">
        ...
        // Avertissement avec boutons dramatiques
        ?>
        <style>
        .dramatic-btn {
        ...
        <div class="container py-5 text-center">
            <div style="color:#c00;font-size:2.5rem;font-weight:bold;margin-bottom:2rem;">
                ⚠️ Cette action va supprimer toute la base de données, sans retour possible.
            </div>

            <div style="display:flex;justify-content:center;align-items:center;gap:2rem;flex-wrap:wrap;">
                <!-- Bouton Supprimer -->
                <a href="?nuke=confirm" class="dramatic-btn">
                    SUPPRIMER
                </a>

                <!-- Vidéo centrale -->
                <video src="goofy.mp4" autoplay loop playsinline style="max-width:350px;width:90vw;border-radius:1.5rem;box-shadow:0 0 30px #c00;"></video>

                <!-- Bouton Annuler -->
                <a href="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" class="dramatic-btn">
                    ANNULER
                </a>
            </div>
        </div>
